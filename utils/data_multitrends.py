...
class ZeroShotDataset():
    def __init__(self, args, data_df, img_root, gtrends, cat_dict, col_dict, fab_dict, trend_len):
    ...
    def get_loader(self, batch_size, train=True, num_workers=0):
        print('Starting dataset creation process...')
        data_with_gtrends = self.preprocess_data()
        data_loader = None
        if train:
            print('available num os',os.cpu_count())
            data_loader = DataLoader(data_with_gtrends,
